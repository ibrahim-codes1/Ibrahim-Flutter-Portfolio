...
class AnimatedCursorProvider extends ChangeNotifier {
  ...
  void updateCursorPostion(Offset postion) {
              ...
              Positioned.fill(
                child: MouseRegion(
                  ...
                  onHover: (event) => context
                      ...
                      .updateCursorPostion(event.position),
                ),
              ),
              Visibility(
                ...
                child: AnimatedPositioned(
                  ...
                  left: state.offset1.dx - state.size2.width / 2,
...
class AnimatedCircleCursorMouseRegion extends StatefulWidget {
  ...
  AnimatedCircleCursorMouseRegion({super.key, required this.child});
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      onHover: (_) => cubit.changeCursor(
        key: _key,
        boxDecoration: CursorConstants.boxDecorationHovered,
      ),
